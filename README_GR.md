...
4. ✅ Κατανοείς πώς η Python αλληλεπιδρά με το DOM και «ζωντανεύει» τις ιστοσελίδες σου!

## Πριν ξεκινήσεις
Πρόκειται για hands-on workshop. Βεβαιώσου ότι έχεις:
- 💻 A laptop (προτείνεται Chrome ή Firefox browser).
- 📶 Πρόσβαση στο διαδίκτυο (το PyScript φορτώνει από CDN).
- Προαιρετικό: κάντο παρέα με κάποιο άτομο δίπλα σου!
